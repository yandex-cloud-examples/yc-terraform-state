...
Пример конфигурационного файла Terraform `main.tf` расположен в этом репозитории.

#### См. также

* Практическое руководство [Блокировка состояний Terraform с помощью Yandex Managed Service for YDB](https://yandex.cloud/ru/docs/tutorials/infrastructure-management/terraform-state-lock).
