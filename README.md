...
Пример конфигурационного файла Terraform `main.tf` с настройкой бэкенда, описывающий хранение состояния, расположен в этом репозитории. Настройки применимы для Terraform 1.6.3 и более поздних версий.
